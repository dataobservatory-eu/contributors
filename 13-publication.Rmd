...
add_graphics(file.path('webp', 'screenshot_post_source_code.webp'), 
             file.path('png', 'screenshot_post_source_code.png'))
```
...
```{r installhugo, echo=FALSE, mesage=FALSE, fig.cap="You can install [hugo](https://gohugo.io/installation/) on any major computer operating system. However, if you use RStudio, we recommend that you install it with blogdown::install_hugo()"}
add_graphics(file.path("webp", "screenshot_install_hugo.webp"), 
             file.path("png", "screenshot_install_hugo.png"))
```
...
add_graphics(file.path("webp", "screenshot_static_folder_in_sfs.webp"), 
             file.path("png", "screenshot_static_folder_in_sfs.png"))
```
