...
```{r, echo=FALSE, message=FALSE, "Screenshot: Editing a webiste page." }
knitr::include_graphics(file.path('webp', 'screenshot_post_source_code.webp'))
```
...
knitr::include_graphics(file.path("webp", "screenshot_fork_the_website_source.webp"))
```
...
```{r, echo=FALSE, message=FALSE, fig.cap="We use [RStudio](https://posit.co/download/rstudio-desktop/) from Posit, but you can use any editor."}
knitr::include_graphics(file.path("webp", "screenshot_install_r_studio.webp"))
```
...
```{r, echo=FALSE, mesage=FALSE, fig.cap="You can install [hugo](https://gohugo.io/installation/) on any major computer operating system. However, if you use RStudio, we recommend that you install it with blogdown::install_hugo()"}
knitr::include_graphics(file.path("webp", "screenshot_install_hugo.webp"))
```
...
knitr::include_graphics(file.path("webp", "screenshot_static_folder_in_sfs.webp"))
```
