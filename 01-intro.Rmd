...
add_graphics( file_path_html=file.path("webp", "opa_framework.webp"),
              file_path_other=file.path("png", "opa_framework.png") )
```
...
add_graphics( 
  file_path_html=file.path("webp", "report-european-music-economy_0_1.webp"),
  file_path_other=file.path("png", "report-european-music-economy_0_1.png") 
  )
