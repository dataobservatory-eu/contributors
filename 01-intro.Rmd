...
Each level must be fully replicable. Establishing a clear link between input and output by displaying how the output changes under `Open Music Europe` uses `Open Policy Analysis` to create policy-relevant indicators. [@OPA_guardia_et_al_2020; @acre_guide] and they are fully in line with the Open Science objectives of the European Union 
...
if (knitr::is_html_output()) {
 ...
 knitr::include_graphics(file.path("png", "opa_framework.png")) 
}
